...
####!!!! Check 0 cleaning fare for statement processing 
confirmed %>% 
  filter(Cleaning.fare==0 & !Source %in% c('Expedia','homesVillasByMarriott',"Expedia Affiliate Network")) %>% 
  select(Listing, Confirmation.Code,CheckIn,CheckOut,Earnings,Source)

# check Guesty to see if Cleaning fee item is 0
