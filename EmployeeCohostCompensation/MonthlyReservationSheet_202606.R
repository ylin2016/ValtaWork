...
dim(confirmed)
cancelled = cancelled_input(fileloc,filemonth) #119
dim(cancelled)
...
dups = duplicated_reservations_lastmonth(confirmed,prior1="2026-05-01")
...
length(unique(reservations$Listing)) #85
