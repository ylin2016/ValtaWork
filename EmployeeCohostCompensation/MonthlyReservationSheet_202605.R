...
confirmed = confirmed %>% filter(!(grepl('owner|Owner',Source)| Earnings %in% 0)) #318

cancelled = cancelled_input(fileloc,filemonth) #93
...
dups = duplicated_reservations_lastmonth(confirmed,prior1="2026-04-01")
...
length(unique(reservations$Listing)) #75
