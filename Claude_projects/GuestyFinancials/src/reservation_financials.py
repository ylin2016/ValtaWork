"""Show the financial breakdown of a single Guesty reservation.
    ...
    python -m src.reservation_financials HMTSFNDRDY          # by confirmation code
    python -m src.reservation_financials 699501306943289afe34fe27   # by reservation _id
    python -m src.reservation_financials HMTSFNDRDY --json   # also dump raw money to data/
    python -m src.reservation_financials HMTSFNDRDY --excel  # also write a line-item .xlsx
