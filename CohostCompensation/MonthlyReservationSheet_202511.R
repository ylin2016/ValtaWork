...
dups = duplicated_reservations_lastmonth(confirmed,prior1="2025-10-01")
...
length(unique(reservations$Listing)) #74
...
newemplyee = "Sophia"
emplyee_thisyear=c("Bri","VA","Destenit")
