...
txts = c("Longbranch","Hoodsport","Keaau","Lilliwaup",
         paste0("OSBR ",1:12),"Ocean Spray 8","Ocean Spray","OSBR","Seatac","OSBR GYM",
         "Microsoft 14620 E205","Microsoft 14645 C19","Microsoft E205","Microsoft D303",
         "OSBR 11","Burien 14407 Middle","Burien 14407 Top",
         "Mercer Island 2449","Beachwood","Lilliwapu","beachwood","11321 kirkland.jpg",
         "Jing Properties","Kirkland D201","Kirkland D210")
chngs = c("Longbranch 6821","Hoodsport 26060","Keaau 15-1542","Lilliwaup 28610",
          paste0("Cottage ",1:12),"Cottage 8","OSBR","OSBR","Seatac 12834","OSBR",
          "Microsoft 14620-E205","Microsoft 14645-C19","Microsoft 14620-E205","Microsoft 14615-D303",
          "Cottage 11 (tiny)","Burien 14407 middle","Burien 14407 top",
          "Mercer 2449","Beachwood","Lilliwaup 28610","Beachwood","Kirkland 11321",
          "Seatac 12834","Kirkland 8252-D201","Kirkland 8252-D201")
...
txts = c("_OSBR_","12834 SeaTac","Lilliwaup","Hoodsport","Longbranch",
         "3956 poulsbo","1940 bellevue","ocean spray","Ocean Spray",
         paste0("beachwood ",1:10),paste0("Beachwood unit ",1:10), paste0("beachwood unit ",1:10),
         "14507 bellevue","OSBR","13020 bellevue","elektra 1108","11321 kirkland|11321 kirkl","unit 9 rent",
         "redmond 7579","elektra 809")
chngs = c("OSBR","Seatac 12834","Lilliwaup 28610","Hoodsport 26060","Longbranch 6821",
          "Poulsbo 3956","Bellevue 1940","OSBR","OSBR",
          paste0("Beachwood ",rep(1:10,3)),
          "Bellevue 14507","OSBR","Bellevue 13020","Elektra 1108","Kirkland 11321","Beachwood 9",
          "Redmond 7579","Elektra 809")
for(k in 1:length(txts))
{
...
files$property[grepl("Beachwood Flood Insurance|Beachwood Insurance",files$file)] = "Beachwood"
