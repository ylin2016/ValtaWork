...
files$property[grep("marketing|Marketing|Multi-units|_All Units_|_Supply_",files$file)] = "Valta Realty"

files %>% filter(!is.na(property1) & is.na(property)) %>% 
  select(file,property1) %>% View()

txts = c("Longbranch","Hoodsport","Keaau","Keaau 1542","Lilliwaup","Beachwood",paste0("Beachwood ",1:10),
         paste0("OSBR ",c(1:10,12)),"OSBR 11","Cottage 11","OSBR", "Seatac 12834 ADU")
chngs = c("Longbranch 6821","Hoodsport 26060","Keaau 15-1542","Keaau 15-1542",
          "Lilliwaup 28610","Beachwood",paste0("Beachwood ",1:10),
          paste0("Cottage ",c(1:10,12)),"Cottage 11 (tiny)","Cottage 11 (tiny)",
          "OSBR","Seatac 12834")
...
txts = c("1424C","28610 Lilliwaup","Edmonds 7819","2323 Bellevue")
chngs = c("Seattle 1424C","Lilliwaup 28610","Edmonds 7819","Bellevue 2323")
...
View(files %>% select(loc1,file,property))
