...
txts = c("Longbranch","Hoodsport","Keaau","Lilliwaup",
         ...
         "Mercer Island 2449","Beachwood","Shelton250","Seattle1430B","Bellevue MS D303",
         "Redmond 7959","Ocean Spray 4")
chngs = c("Longbranch 6821","Hoodsport 26060","Keaau 15-1542","Lilliwaup 28610",
          ...
          "Mercer 2449","Beachwood","Shelton 250","Seattle 1430B","Microsoft 14615-D303",
          "Redmond 7579","Cottage 4")
...
txts = c("_OSBR_|OceanSpray|ocean spray|OSBR|Ocean Spray","12834 SeaTac",
         ...
         "14507 bellevue","9750 Seattle","11321 kirkland")
chngs = c("OSBR","Seatac 12834",
          "Lilliwaup 28610","Hoodsport 26060","Longbranch 6821",
          paste0("Beachwood ",rep(1:10,3)),
          "Bellevue 14507","Seattle 9750","Kirkland 11321")
for(k in 1:length(txts))
{
...
files$property[grepl("Beachwood 739.80",files$file)] = "Beachwood"
