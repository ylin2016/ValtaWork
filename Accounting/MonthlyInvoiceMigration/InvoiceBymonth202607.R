...
chngs = c("Longbranch 6821","Hoodsport 26060","Keaau 15-1542","Keaau 15-1542","Lilliwaup 28610",
...
txts = c("yacinde","Yacinde","cottage 5","OSBR",'osbr',"6821 longbranch",
         '16237 Bellevue',"Shoreline 15510")
chngs = c("Yacinde","Yacinde","Cottage 5", "OSBR","OSBR","Longbranch 6821",
          "Bellevue 16237","Shoreline 15510")
for(k in 1:length(txts))
{
