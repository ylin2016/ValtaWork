...
txts = c("Longbranch","Hoodsport","Keaau","Lilliwaup",
         paste0("OSBR ",1:12),"Ocean Spray 8","Ocean Spray","Microsoft D303","OSBR","Seatac","Osbr",
         "OSBR 11","Burien 14407 Middle","Burien 14407 Top",
         "Beachwood 6","Mercer Island 2449","13020",
          "Microsoft 14620 E205","Microsoft 14645 C19","Microsoft E205",
        "Jing Properties","Seatac 12934","Kirkkland 10219")
chngs = c("Longbranch 6821","Hoodsport 26060","Keaau 15-1542","Lilliwaup 28610",
          paste0("Cottage ",1:12),"Cottage 8","OSBR","Microsoft 14615-D303","OSBR","Seatac 12834","OSBR",
          ...
          "Seatac 12834","Seatac 12834","Kirkland 10219")
...
txts = c("_OSBR_","12834 SeaTac","Lilliwaup","Hoodsport","Longbranch",
         "3956 poulsbo","1940 bellevue","Beachwood rent unit 9","osbr",
         paste0("beachwood ",1:10),paste0("Beachwood unit ",1:10), paste0("beachwood unit ",1:10),
         "14507 Unit","OSBR","13020 bellevue","elektra 1108")
chngs = c("OSBR","Seatac 12834","Lilliwaup 28610","Hoodsport 26060","Longbranch 6821",
          "Poulsbo 3956","Bellevue 1940","Beachwood 9","OSBR",
          paste0("Beachwood ",rep(1:10,3)),
          "Bellevue 14507","OSBR","Bellevue 13020","Elektra 1108")
for(k in 1:length(txts))
{
...
files$property[grepl("Beachwood rent unit 9",files$file)] = "Beachwood 9"
