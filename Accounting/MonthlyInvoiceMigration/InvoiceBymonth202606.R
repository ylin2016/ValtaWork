...
oldloc = paste0('/Users/ylin/Google Drive/My Drive/Accounting/Company Transactions/2026/',Month)
...
txts = c("Longbranch","Hoodsport","Keaau","Lilliwaup","Beachwood",paste0("Beachwood ",1:10),
         ...
         "Seattle 10057","Bellevue 2323","3956 Poulsbo","Bainbridge",
         "Seattle 906","Bellevue C19","Microsoft D303","Microsoft E205",
         "BellevueD303","Seattle 7434 Whole","Elecktra 809","12834 SeaTac",
         "Bellevue 2323","Seattle 10057")
chngs = c("Longbranch 6821","Hoodsport 26060","Keaau 15-1542","Lilliwaup 28610",
          ...
          "Seattle 10057 Whole","Bellevue 2323 Whole","Poulsbo 3956","Bainbridge 11143",
          "Seattle 906 Lower","Microsoft 14645-C19","Microsoft 14615-D303","Microsoft 14620-E205",
          "Microsoft 14615-D303","Seattle 7434","Elektra 809","Seatac 12834",
          "Bellevue 2323 Whole","Seattle 10057 Whole")
...
txts = c("Beachwood","11143 Bainbridge","11143 bainbridge", "Bellevue 1326",
         "Seattle1502","6821 long branch","Mercer2449","Lilliwaup 28610")
chngs = c("Beachwood","Bainbridge 11143", "Bainbridge 11143","Bellevue 1326",
          "Seattle 1502","Longbranch 6821","Mercer 2449","Lilliwaup 28610")
for(k in 1:length(txts))
{
...
files = files %>% filter(!grepl(".csv|.gsheet",file)) 
...
{
  print(k)
  if(grepl("Beachwood|OSBR|Cottage",files_loc$property[k])){
...
for(k in unique(files_loc$loc))
{
  if(sum(files_loc$property[files_loc$loc %in% k] %in% c("Valta Realty","BookingCommission"))==0 &
     !grepl("Beachwood|OSBR|Cottage",k))
    {
