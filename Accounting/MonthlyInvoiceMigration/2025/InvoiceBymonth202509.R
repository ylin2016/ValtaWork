...
txts = c("Longbranch","Hoodsport","Keaau","Lilliwaup","Beachwood",paste0("Beachwood ",1:10),
         ...
         "Microsoft C19","Microsoft 14645 C19","OSBR CS","OSBR C3","	OSBR 3","OSBR3",
         "Shelton310","Bellevue 14707","Bellevue 14507 U3")
chngs = c("Longbranch 6821","Hoodsport 26060","Keaau 15-1542","Lilliwaup 28610",
          ...
          "Microsoft 14645-C19","Microsoft 14645-C19","OSBR",rep("Cottage 3",3),
          "Shelton 310","Redmond 14707","Bellevue 14507U3")
...
txts = c("Shelton 310","Ocean Spray Beach Resort","OSBR","4027 Seattle Beachwood")
chngs = c("Shelton 310","OSBR","OSBR","Beachwood")
for(k in 1:length(txts))
{
