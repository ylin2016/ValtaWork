...
txts = c("Longbranch","Hoodsport","Keaau","Lilliwaup","Beachwood",paste0("Beachwood ",1:10),
         paste0("OSBR ",c(1:10,12)),"OSBR 11","OSBR","Seatac 12834","Jing Zhou")
chngs = c("Longbranch 6821","Hoodsport 26060","Keaau 15-1542","Lilliwaup 28610",
          "Beachwood",paste0("Beachwood ",1:10),
          paste0("Cottage ",c(1:10,12)),"Cottage 11 (tiny)","OSBR","Seatac 12834","Seatac 12834")
...
txts = c("Bellevue 14507 unit 1","Kirkland 8017","6821 Longbranch",
         "OSBR Media room","- OSBR","OSBR",
         "Elektra 703","Elektra 809","Longbranch 6821","Bellevue 1326","Kirkland 11321")
chngs = c("Bellevue 14507U1","Kirkland 8017","Longbranch 6821",
          "OSBR","OSBR","OSBR",
          "Elektra 703","Elektra 809","Longbranch 6821","Bellevue 1326","Kirkland 11321")
for(k in 1:length(txts))
{
