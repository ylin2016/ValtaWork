...
txts = c("Longbranch","Hoodsport","Keaau","Lilliwaup",
         ...
         "Mercer Island 2449","Woodinville")
...
txts = c("_OSBR_|OceanSpray|ocean spray|OSBR|Ocean Spray","12834 SeaTac","_Beachwood_",
         ...
         "14507 bellevue|Bellevue_14507","1108 elektra","19319 woodinville",
         "12834 seatac","1424c seattle|_1424C_","Microsoft_E205|E205",
         "D201|Kirkland_D201","Mircosoft D303")
chngs = c("OSBR","Seatac 12834","Beachwood",
          "Lilliwaup 28610","Hoodsport 26060","Longbranch 6821",
          paste0("Beachwood ",rep(1:10,3)),
          "Bellevue 14507","Elektra 1108","Woodinville 19319",
          "Seatac 12834","Seattle 1424C","Microsoft 14620-E205",
          "Kirkland 8252-D201","Microsoft 14615-D303")
for(k in 1:length(txts))
{
