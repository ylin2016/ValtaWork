...
txts = c("Longbranch","Hoodsport","Keaau","Lilliwaup","Beachwood",paste0("Beachwood ",1:10),
         ...
         "Lillowaup 28610","14507 U1","Seattle 10057",
         "Shelton310","Seattle 906","Microsoft C19","LongBranch")
chngs = c("Longbranch 6821","Hoodsport 26060","Keaau 15-1542","Lilliwaup 28610",
          ...
          "Lilliwaup 28610","Bellevue 14507U1","Seattle 10057 Whole",
          "Shelton 310","Seattle 906 Lower","Microsoft 14645-C19","Longbranch 6821")
...
txts = c("Bellevue 16237","Bellevue16237","Beachwood apt unit 8","Shelton 250",
         "Pulsbo 3956","Beachwood 2-Home","Elektra703")
chngs = c("Bellevue 16237","Bellevue 16237","Beachwood 8","Shelton 250",
          "Poulsbo 3956","Beachwood 2","Elektra 703")
for(k in 1:length(txts))
{
