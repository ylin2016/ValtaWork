...
txts = c("Beachwood","26060 Hoodsport","Shelton 250","BW 9","oceanspray","Ocean Spray Beach",
         "4201_LS","310 LS")
chngs = c("Beachwood","Hoodsport 26060","Shelton 250","Beachwood 9","OSBR","OSBR",
          "Seattle 4201","Shelton 310")
for(k in 1:length(txts))
{
