...
txts = c("Longbranch","Hoodsport","Keaau","Lilliwaup",
         ...
         "OSBR 11","Beachwood","Burien 14407 Middle","Burien 14407 Top",
         "Beachewood","Mercer Island 2449","1424C.jpg","Keaau 1542",
         "Multi-unit Supplies","Multi unit supplies","Multi Unit Supplies"," Multi-unit supplies",
         "Microsoft 14620 E205","Microsoft 14645 C19","Microsoft E205",
         "Bellevue 14645 C19","E205 Microsoft.jpg","Seattle 1430","Seattle1502",
         "OSBR Others","Ocean Spray","32671.pdf","Jing Properties")
chngs = c("Longbranch 6821","Hoodsport 26060","Keaau 15-1542","Lilliwaup 28610",
          ...
          "Cottage 11 (tiny)","Beachwood","Burien 14407 middle","Burien 14407 top",
          "Beachwood","Mercer 2449","Seattle 1424C","Keaau 15-1542",
          "Valta Realty","Valta Realty","Valta Realty","Valta Realty",
          "Microsoft 14620-E205","Microsoft 14645-C19","Microsoft 14620-E205",
          "Microsoft 14645-C19","Microsoft 14620-E205","Seattle 1430B","Seattle 1502",
          "Valta Realty","OSBR","Beachwood","Seatac 12834")
...
txts = c("_OSBR_","12834 SeaTac","Lilliwaup","Hoodsport",
         "Poulsbo563","601 deposit","ocb homedepot",
         "C19 Microsoft","2642 issauquah","2462 Issaquah","beachwood 7",
         "Beachwood unit 10", "14507 Unit","Beachwood unit 5","Beachwood 9","OSBR")
chngs = c("OSBR","Seatac 12834","Lilliwaup 28610","Hoodsport 26060",
          "Poulsbo 563","Bellevue 601","OSBR",
          "Microsoft 14645-C19","Issaquah 2642","Issaquah 2642","Beachwood 7",
          "Beachwood 10", "Bellevue 14507","Beachwood 5","Beachwood 9","OSBR")
for(k in 1:length(txts))
{
...
files$property[grepl("Beachwood unit 10",files$file)] = "Beachwood 10"
