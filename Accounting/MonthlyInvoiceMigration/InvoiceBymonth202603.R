...
txts = c("Longbranch","Hoodsport","Keaau","Lilliwaup","Beachwood",paste0("Beachwood ",1:10),
         ...
         "Seattle 10057",
         "Seattle 906","Microsoft C19","Microsoft D303","Microsoft E205",
         "Seattle 8415 ","Bellevue 2243 ","Liliwaup 28610","Bellevue  2243",
         "Lake Steves 7626","Seatac ADU")
chngs = c("Longbranch 6821","Hoodsport 26060","Keaau 15-1542","Lilliwaup 28610",
          ...
          "Seattle 10057 Whole",
          "Seattle 906 Lower","Microsoft 14645-C19","Microsoft 14620-E205",
          "Microsoft 14615-D303","Seattle 8415","Bellevue 2243",
          "Lilliwaup 28610","Bellevue 2243","Lake Stevens 7626","Seatac 12834")
...
txts = c("OSBR tiny","office expense grayland")
chngs = c("Cottage 11 (tiny)","OSBR")
for(k in 1:length(txts))
{
...
files = files %>% filter(!property1 %in% "Jackson Livy") 
