...
files$property1 = sapply(files$file,function(x,listings) 
  {
    ...
    txts = ifelse(grepl("amazon|Amazon|Costco|Walmart",x),txt4,txts)
  },listings=listings)
...
txts = c("Longbranch","Hoodsport","Keaau","Lilliwaup",
         "OSBR 2","Kikrland 10219","Microsoft D303","OSBR","OSBR ",
         "Poulsbo 3965","OSBR 11","Beachwood","Safely","Burien 14407 Middle",
         "Burien 14407 Top")
chngs = c("Longbranch 6821","Hoodsport 26060","Keaau 15-1542","Lilliwaup 28610",
          "Cottage 2","Kirkland 10219","Microsoft 14615-D303","OSBR","OSBR",
          "Poulsbo 3956","Cottage 11 (tiny)","Beachwood","Elektra 1115","Burien 14407 middle",
          "Burien 14407 top")
...
txts = c("beachwood unit8|Beachwood unit 8","OSBR Caregiver|_OSBR_","_D303_|D303 Bellevue","Poulsbo 3965","_OSBR 1_",
         "_shelton 250_","all unit|All unit|Multi-unit supplies","2449 mercer",
         "1108 Elektra","15357 Redmond","14507 Bellevue Unit 4")
chngs = c("Beachwood 8","OSBR","Microsoft 14615-D303","Poulsbo 3956","Cottage 1",
          "Shelton 250","Valta Realty","Mercer 2449",
          "Elektra 1108","Redmond 15357","Bellevue 14507")
for(k in 1:length(txts))
{
...
files$property[files$property1 %in% c('Maria',"Valta","0SBR and Others Sirens cleaning ","Multi-unit supplies","all unit supplies")] = "Valta Realty"
