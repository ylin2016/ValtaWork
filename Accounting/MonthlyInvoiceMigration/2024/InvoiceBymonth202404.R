...
txts = c("_OSBR_","12834 SeaTac","Lilliwaup","Hoodsport","Longbranch",
         ...
         "14507 bellevue","OSBR","1115 elektra","1430b","2642 issaquah|2462 issaquah",
         "Woodinvile","elektra 1004","703 e","mercer 2449","elektra D303")
chngs = c("OSBR","Seatac 12834","Lilliwaup 28610","Hoodsport 26060","Longbranch 6821",
          ...
          "Bellevue 14507","OSBR","Elektra 1115","Seattle 1430B","Issaquah 2642",
          "Woodinville 19319","Elektra 1004","Elektra 703","Mercer 2449","Microsoft 14615-D303")
for(k in 1:length(txts))
{
...
idx = grepl("Seattle 710|Shelton 310|Burien 14407",files$property1)
files$property[idx] = files$property1[idx]
