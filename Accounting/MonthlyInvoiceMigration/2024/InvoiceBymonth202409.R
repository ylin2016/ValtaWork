...
txts = c("Longbranch","Hoodsport","Keaau","Lilliwaup",
         ...
         "Burien 14407 Top","Beachewood","Mercer Island 2449","Bellevue 2449",
         ...
         "OSBR Others","Ocean Spray","32671.pdf")
...
txts = c("_OSBR_","12834 SeaTac","2009 Map","Lilliwaup","Hoodsport",
         "1512map", "14507 Unit","4027 seattle beachwood","4027 Seattle Beachwood","OSBR Legal")
chngs = c("OSBR","Seatac 12834","Sammamish 2009","Lilliwaup 28610","Hoodsport 26060",
          "Seattle 1512", "Bellevue 14507","Beachwood","Beachwood","OSBR")
for(k in 1:length(txts))
{
...
for(k in c("Beachwood 5","Beachwood 9"))
{
  idx = grepl(k,files$file)
  files$property[idx] = k
} 
